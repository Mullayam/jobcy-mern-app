...
function Projects({ user_id, projectList }) {
                          ...
                          <Col lg={10}>
                            <div className="mt-3 mt-lg-0">
                              ...
                              <ul className="list-inline mb-0">
                                ...
                                <li className="list-inline-item">
                                  <p className="text-muted fs-14 mb-0">
                                    {project.startWorkingFrom}
                                  </p>
                                </li>
                              </ul>
                              <div className="mt-2">
                                <span className="badge bg-blue-subtle text-blue fs-13 mt-1">
                                  <i className="uil uil-users-alt"></i> Team:{" "}
                                  {project.teamSize}
                                </span>
                                <span className="badge bg-blue-subtle text-blue fs-13 mt-1">
                                  Role: {project.role}
                              ...
                              <small>{project.detailsOfProject}</small>
                            </div>
                          </Col>
          ...
          <div className="modal-content">
            ...
            <ModalBody>
              <div>
                  ...
                  <Row>
                    ...
                    <Col lg={12}>
                      <div className="mb-3">
                        ...
                        <small className="text-muted">
                          Please Enter if Project for Organization else Personal
                          is default
                        </small>
                      </div>
                    </Col>
                    <Col lg={12}>
                      <div className="mb-3">
                        ...
                        />
                        <small className="text-muted">
                          Enter Project purpose Clien/Personal/Freelance/other
                          please mention it
                        </small>
                      </div>
                    </Col>
                ...
                <div className="mt-4">
                  <h5 className="fs-17 fw-semibold mb-3">More Details</h5>
                  ...
                  <Row>
                    ...
                    <Col lg={12}>
                      <div className="mb-3">
                        <Label htmlFor="skillsUsed" className="form-label">
